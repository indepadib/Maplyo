...
export const AUTH_COPY: Record<Language, AuthCopy> = {
  fr: {
    ...
    update: { title: "Choisissez un nouveau mot de passe", subtitle: "Définissez un mot de passe sécurisé pour votre compte Maplyo.", password: "Nouveau mot de passe", confirm: "Confirmer le mot de passe", submit: "Mettre à jour", loading: "Mise à jour…", successTitle: "Mot de passe mis à jour", successText: "Votre nouveau mot de passe est actif.", dashboard: "Ouvrir Maplyo", mismatch: "Les mots de passe ne correspondent pas." }
  },
  en: {
    ...
    update: { title: "Choose a new password", subtitle: "Set a secure password for your Maplyo account.", password: "New password", confirm: "Confirm password", submit: "Update password", loading: "Updating…", successTitle: "Password updated", successText: "Your new password is now active.", dashboard: "Open Maplyo", mismatch: "Passwords do not match." }
  },
  es: {
  ...
  ar: {
    ...
    update: { title: "اختر كلمة مرور جديدة", subtitle: "حدد كلمة مرور آمنة لحساب Maplyo.", password: "كلمة المرور الجديدة", confirm: "تأكيد كلمة المرور", submit: "تحديث كلمة المرور", loading: "جارٍ التحديث…", successTitle: "تم تحديث كلمة المرور", successText: "كلمة المرور الجديدة أصبحت فعالة.", dashboard: "فتح Maplyo", mismatch: "كلمتا المرور غير متطابقتين." }
  },
  nl: {
  ...
  zh: {
    ...
    update: { title: "设置新密码", subtitle: "为你的 Maplyo 账户设置安全密码。", password: "新密码", confirm: "确认密码", submit: "更新密码", loading: "正在更新…", successTitle: "密码已更新", successText: "新密码已经生效。", dashboard: "打开 Maplyo", mismatch: "两次密码不一致。" }
  },
  pt: {
    ...
    update: { title: "Escolha uma nova palavra-passe", subtitle: "Defina uma palavra-passe segura para a sua conta Maplyo.", password: "Nova palavra-passe", confirm: "Confirmar palavra-passe", submit: "Atualizar palavra-passe", loading: "A atualizar…", successTitle: "Palavra-passe atualizada", successText: "A nova palavra-passe já está ativa.", dashboard: "Abrir Maplyo", mismatch: "As palavras-passe não coincidem." }
  }
};
