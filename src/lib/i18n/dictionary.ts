...
export const DICTIONARY = {
    ...
    ar: {
        ...
        showcase: {
            tag: "أمثلة واقعية",
            title: "مناسب لجميع أنواع العقارات",
            subtitle: "سواء كنت تدير استوديو أو فندقًا، يتكيف مابليو مع أسلوبك.",
            viewFull: "عرض الدليل الكامل",
            messageFrom: "رسالة من",
            types: {
                apartment: "شقة",
                vacationHome: "منزل عطلات",
            ...
            reviews: {
                sarah: "شكرًا على الدليل، كان الوصول سهلاً للغاية!",
                marcJulie: "أحببنا توصيات المطاعم!",
                thomas: "رمز الواي فاي أنقذ وصولنا."
            }
        },
        ...
        builder: {
            ...
            close: "إغلاق",
            selectBlock: "اختر كتلة لتعديلها",
            paramsHere: "ستظهر المعلمات هنا",
            designTheme: "التصميم والمظهر",
            upgradePro: "قم بالترقية للمحترف لفتح جميع المظاهر.",
            unlock: "فتح",
            unlockPublish: "فتح النشر",
            publishDesc: "النشر متاح للمشتركين فقط. اشترك لمشاركة دليلك!",
            seeOffers: "عرض العروض",
            createAccount: "إنشاء حساب",
            saveCreateAccount: "حفظ (إنشاء حساب)",
            online: "منشور",
            unpublish: "إلغاء النشر",
            confirmUnpublish: "هل تريد حقاً سحب هذا الدليل؟",
            publish: "نشر",
        ...
        editor: {
            common: {
                ...
                priceModerate: "متوسط",
                priceExpensive: "فاخر",
                placeholderAddress: "شارع مثال 123، الدار البيضاء",
                placeholderMap: "https://goo.gl/maps/...",
                placeholderPhone: "+212 600 000 000",
                placeholderWhatsapp: "212600000000",
                placeholderEmail: "contact@example.com",
            ...
            checkin: {
                timePlaceholder: "مثال: 15:00",
                instrPlaceholder: "تعليمات الوصول..."
            },
            contact: {
            ...
            rules: {
                title: "قاعدة",
                add: "إضافة قاعدة",
                placeholder: "مثال: لا ضوضاء بعد الساعة 10 مساءً"
            },
            amenities: {
                title: "مرفق",
                add: "إضافة مرفق",
                placeholder: "مثال: آلة صنع القهوة"
            },
            faq: {
                question: "السؤال",
                answer: "الجواب",
                add: "إضافة سؤال",
                qPlaceholder: "مثال: هل يوجد واي فاي؟",
                aPlaceholder: "نعم، الرمز هو..."
            },
            trash: {
                dayTrash: "يوم القمامة",
                dayRecycling: "يوم إعادة التدوير",
                location: "موقع الحاويات",
                photoLocal: "صورة المكان"
            },
            parking: {
                photo: "صورة الموقف",
                costPlaceholder: "مثال: مجاني / 20 درهم للساعة"
            },
            breakfast: {
                menu: "في القائمة / تفاصيل",
                menuPlaceholder: "بوفيه كونتيننتال، منتجات محلية..."
            },
            transport: {
                add: "إضافة وسيلة نقل",
                stop: "الوصف / المحطة",
            ...
            places: {
                name: "اسم المكان",
                add: "إضافة مكان",
                aiButton: "توصية ذكاء اصطناعي"
            },
            events: {
                add: "إضافة فعالية",
                month: "الشهر (3 أحرف)",
                day: "اليوم",
                aiButton: "البحث عن فعاليات"
            },
            documents: {
                add: "إضافة مستند",
                name: "اسم مستند",
            ...
            access_codes: {
                ...
                unlockByCode: "إلغاء القفل بالرمز",
                unlockCode: "رمز إلغاء القفل",
                unlockCodeDesc: "مثال: الرمز الذي ترسله للضيف.",
                aptCode: "رمز باب الشقة",
                buildingCode: "رمز باب المبنى",
        ...
        guideBlocks: {
            ...
            accessCodes: { code: "رمز الدخول", location: "الموقع", instruction: "التعليمات" },
            location: { viewOnMap: "عرض على الخريطة", address: "العنوان" },
            transport: { getThere: "كيفية الوصول", parking: "موقف السيارات" }
        }
    },
    nl: {
        common: {
