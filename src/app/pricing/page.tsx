                ...
                <div className="grid md:grid-cols-3 gap-8 items-stretch pt-4">
                    ...
                    <div className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-xl shadow-gray-200/50 flex flex-col hover:border-gray-300 transition-all duration-300 relative group">
                        <div className="mb-6">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-2">{t.pricing.plans.demo.name}</h3>
                            <div className="flex items-baseline gap-1">
                                <span className="text-4xl font-black text-gray-900">{t.pricing.plans.demo.price}</span>
                            </div>
                            <p className="text-gray-500 mt-4 text-sm font-medium">{t.pricing.plans.demo.desc}</p>
                        </div>
