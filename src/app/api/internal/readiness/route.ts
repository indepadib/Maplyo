...
export async function GET(req: Request) {
  ...
  const dbChecks = await Promise.all([
    ...
    tableCheck(admin, "property_payment_settings", "Revenue · payment orchestration"),
    tableCheck(admin, "guest_requests", "Operations · guest requests"),
    tableCheck(admin, "journey_rules", "Automation · journey rules"),
    tableCheck(admin, "journey_deliveries", "Automation · journey deliveries"),
    tableCheck(admin, "stay_links", "Stay Operations · personalized links"),
